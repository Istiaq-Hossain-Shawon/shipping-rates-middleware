...
@Entity
@Table(name = "city_link_express_request_tbl")
public class CityLinkExpressRequest {
	...
	public String toString() {
		return "CityLinkExpressRequest [id=" + id + ", originCountry=" + originCountry + ", originState=" + originState
	...
	public int hashCode() {
		return Objects.hash(createdAt, destinationCountry, destinationPostcode, destinationState, documentWeight,
				height, id, length, originCountry, originPostcode, originState, parcelWeight, selectedType, width);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CityLinkExpressRequest other = (CityLinkExpressRequest) obj;
